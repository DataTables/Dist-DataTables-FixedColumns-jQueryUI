# FixedColumns for DataTables with styling for [jQueryUI](http://jqueryui.com/)

This package contains a built distribution of the [FixedColumns extension](https://datatables.net/extensions/FixedColumns) for [DataTables](https://datatables.net/) with styling for [jQueryUI](http://jqueryui.com/).
...
```
var $ = require( 'jquery' );
var dt = require( 'datatables.net-fixedcolumns-jqui' )( window, $ );
```
